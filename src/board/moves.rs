...
impl MoveGen {
    ...
    fn knight_moves_from_square(
        ...
        let no_wrap = moves
            & !(if knight_bb & FILE_A != 0 {
                FILE_G | FILE_H
            } else if knight_bb & FILE_H != 0 {
                FILE_A | FILE_B
            } else {
                0
            });
    ...
    fn bishop_moves_from_square(&self, board: &ChessBoard, square: u32) -> Bitboard {
        ...
        for &direction in &[7, 9, -7, -9] {
            ...
            loop {
                ...
                if possible & board.all_pieces != 0 {
                    break;
                }
            }
        }
